...
public class Familiar : ItemBase
{
    ...
    public void Spawner()
    {
        for (int attempt = 0; attempt < maxSpawnAttempts; attempt++)
        {
            ...
            {
                Instantiate(spawner, point, Quaternion.identity);
                return;
            }
        }

        Debug.LogWarning("Failed to find valid spawn point for Familiar.");
    }
